...
bool Gomspace::config3(const eps_config3_t &c) {
...
const Gomspace::eps_hk_t& Gomspace::hk_data() { return hk; }
const Gomspace::eps_config_t& Gomspace::config() { return gspace_config; }
const Gomspace::eps_config2_t& Gomspace::config2() { return gspace_config2; }
const Gomspace::eps_config3_t& Gomspace::config3() { return gspace_config3; }
